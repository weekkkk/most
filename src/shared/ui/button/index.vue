...
<template>
  <button
    ...
    :class="[
      ...
      {
        'p-[1.5rem] md:px-[4rem] max-md:h-[4rem] max-md:px-12 md:rounded-[calc(1.5rem+(1rem/2))] max-md:rounded-[calc(1.5rem+(0.25rem/2))]':
          !img && size === 'medium',
        'md:p-[0.9rem] max-md:p-[0.4rem] max-md:h-[4rem] md:rounded-[calc(18px+(24px/2))] max-md:rounded-[calc(0.4rem+(24px/2))]':
          img && size === 'medium',
        'md:p-[1.5rem] max-md:p-[1.8rem] max-md:h-[4rem] md:rounded-[calc(1.5rem+(24px/2))] max-md:rounded-[calc(1.8rem+(24px/2))]':
          img && size === 'large',
