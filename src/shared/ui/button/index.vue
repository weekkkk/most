...
<template>
  <button
    @click="emit('click')"
    class="inline-flex justify-center items-center md:gap-[0.5rem] max-md:gap-[0.4rem] text-[1rem] max-md:text-[0.7rem] disabled:bg-second-50 disabled:text-common transition-all"
    :class="{
