...
export default defineNuxtConfig({
  ...
  app: {
      ...
      script: [
        {
          ...
          textContent: `(function(m,e,t,r,i,k,a){m[i]=m[i]function(){(m[i].a=m[i].a[]).push(arguments)};
   m[i].l=1*new Date();
   ...
   ym(99861262, "init", {
      ...
      noscript: [
        {
          innerHTML: `<div><img src="https://mc.yandex.ru/watch/99861262" style="position:absolute; left:-9999px;" alt="" /></div>`,
        },
      ],
    },
  },
